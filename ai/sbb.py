...
class Sbb():
    def __init__(self, checkpoint_path, output_size, input_size = (1, 5)):
    ...
    def run(self):
        ...
        model.compile(optimizer=optimizers.Adam(), loss=tf.keras.losses.CategoricalCrossentropy(), metrics=['accuracy']) #, Recall(), Precision()
